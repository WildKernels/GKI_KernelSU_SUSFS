...
| **Pixel** | [Sultan_KernelSU_SUSFS](https://github.com/WildKernels/Sultan_KernelSU_SUSFS) | Custom Sultan kernel by [kerneltoast](https://github.com/kerneltoast) for specific Pixel devices |
